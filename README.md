...
[![Continuous Integration](https://github.com/Sh1n3zZ/go-proxmox/actions/workflows/ci.yaml/badge.svg)](https://github.com/Sh1n3zZ/go-proxmox/actions/workflows/ci.yaml) [![GitHub license](https://img.shields.io/github/license/luthermonson/go-proxmox)](https://github.com/Sh1n3zZ/go-proxmox/blob/main/LICENSE)
[![GitHub issues](https://img.shields.io/github/issues/luthermonson/go-proxmox)](https://github.com/Sh1n3zZ/go-proxmox/issues)
[![GitHub release](https://img.shields.io/github/release/luthermonson/go-proxmox.svg)](https://github.com/Sh1n3zZ/go-proxmox/releases/) [![codecov](https://codecov.io/gh/luthermonson/go-proxmox/graph/badge.svg?token=GQSSZ0ZHZ4)](https://codecov.io/gh/luthermonson/go-proxmox) [![Go Report Card](https://goreportcard.com/badge/github.com/Sh1n3zZ/go-proxmox)](https://goreportcard.com/report/github.com/Sh1n3zZ/go-proxmox) [![Go Reference](https://pkg.go.dev/badge/github.com/Sh1n3zZ/go-proxmox.svg)](https://pkg.go.dev/github.com/Sh1n3zZ/go-proxmox)

Join the community to discuss ongoing client development usage, the proxmox API or tooling in the [#go-proxmox](https://gophers.slack.com/archives/C05920LDDD3) channel on the Gophers Slack and see the [self generated docs](https://pkg.go.dev/github.com/Sh1n3zZ/go-proxmox) for more usage details.
